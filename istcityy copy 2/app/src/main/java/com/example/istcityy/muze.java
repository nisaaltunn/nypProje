...
public class muze extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.muzelist);
        searchView = findViewById(R.id.searchmuze);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("muze");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(muze.this, place.class);
