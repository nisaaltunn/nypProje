...
public class privatehospital extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_privatehospital);

        // Firebase Realtime Database referansını al
        databaseReference = FirebaseDatabase.getInstance().getReference().child("privatehospital");

        // ListView'i layouttan al
        listView = findViewById(R.id.phospitallist);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new ArrayAdapter<>(privatehospital.this, android.R.layout.simple_list_item_1, hospitalNames);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(privatehospital.this, maps.class);
        ...
        SearchView searchView = findViewById(R.id.searchphospital);
