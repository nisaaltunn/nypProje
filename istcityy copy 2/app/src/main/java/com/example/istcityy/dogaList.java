...
public class dogaList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doga_list);

        // Firebase Realtime Database referansını al
        databaseReference = FirebaseDatabase.getInstance().getReference().child("doga");
        ...
        // ValueEventListener oluştur ve StateHospital altındaki alt düğümleri dinle
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new ArrayAdapter<>(dogaList.this, android.R.layout.simple_list_item_1, hospitalNames);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(dogaList.this, maps.class);
        ...
        SearchView searchView = findViewById(R.id.searchHospital);
