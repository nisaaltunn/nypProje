...
public class restoran extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.restoran);
        searchView = findViewById(R.id.searchmichel);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("michel");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(restoran.this, place.class);
